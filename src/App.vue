  ...
  <div id="app">
    ...
    <el-row>
      <el-col :span="14" :offset="5">
        <div id="drapndrop" class="drag-and-drop" @drop.prevent="onFolderDrop" @dragover.prevent>
          拖动文件夹到这里
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      ...
      <el-col :span="4" :offset="10">
        <el-button style="margin-top: 20px;" type="success" @click="exportPng" icon='el-icon-picture'>导出文件 {{filename}}.png</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="24">
        ...
        <div v-else class="preview" ref="preview" :style="{width: `${previewWidth - previewPadding * 2}px`, padding: `${previewPadding}px`}">
          <div class="block" v-for="(item, index) in list" :key="item.name" :style="{margin: `${getMargin(index)}`}">
...
export default {
  ...
  computed: {
    columnSpace: function () {
      const innerWidth = this.previewWidth - this.previewPadding * 2 - 100 * this.columnNumber;
